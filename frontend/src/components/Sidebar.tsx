...
const Sidebar = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 h-full w-64 bg-white dark:bg-surface-dark-secondary border-r border-border dark:border-border-dark z-30 flex flex-col">
